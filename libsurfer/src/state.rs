...
pub struct UserState {
    ...
    pub(crate) align_values_right: Option<bool>,
    ...
    /// Requested pixel width for the signal-name column (applied once, then cleared).
    #[serde(skip, default)]
    pub(crate) requested_name_col_width: Option<f32>,
